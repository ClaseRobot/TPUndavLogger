...
void PruebasLoggerOff()
{
    cout << "Iniciando Pruebas Logger en 'Off level'..." << endl
         << endl;
    ...
    cout << "Finalizadas Pruebas Logger en 'Off level'. No se debio visualizar ningun log." << endl
         << endl;
}

void PruebasLoggerFatal()
{
    cout << "Iniciando Pruebas Logger en 'FATAL level' ..." << endl
         << endl;
    ...
    cout << "Finalizadas Pruebas Logger 'FATAL level'. Se debi� visualizar 1 solo log" << endl
         << endl;
}

void PruebasLoggerError()
{
    cout << "Iniciando Pruebas Logger en 'ERROR level' ..." << endl
         << endl;
    ...
    cout << "Finalizadas Pruebas Logger 'ERROR level'. Se debi� visualizar 2 logs." << endl
         << endl;
}

void PruebasLoggerWarn()
{
    cout << "Iniciando Pruebas Logger en 'WARN level' ..." << endl
         << endl;
    ...
    cout << "Finalizadas Pruebas Logger 'WARN level'. Se debi� visualizar 3 logs." << endl
         << endl;
}

void PruebasLoggerInfo()
{
    cout << "Iniciando Pruebas Logger en 'INFO level' ..." << endl
         << endl;
    ...
    cout << "Finalizadas Pruebas Logger 'INFO level'. Se debi� visualizar 4 logs." << endl
         << endl;
}
void PruebasLoggerDebug()
{
    cout << "Iniciando Pruebas Logger en 'DEBUG level' ..." << endl
         << endl;
    ...
    cout << "Finalizadas Pruebas Logger 'DEBUG level'. Se debi� visualizar 5 logs." << endl
         << endl;
}

void PruebasLoggerTrace()
{
    cout << "Iniciando Pruebas Logger en 'TRACE level' ..." << endl
         << endl;
    ...
    cout << "Finalizadas Pruebas Logger 'TRACE level'. Se debi� visualizar 6 logs." << endl
         << endl;
}
