...
void PruebasLoggerFatal()
{
	...
	cout<<"Finalizadas Pruebas Logger 'FATAL level'. Se debi� visualizar 1 solo log"<<endl<<endl;
}
...
void PruebasLoggerError()
{
	...
	cout<<"Finalizadas Pruebas Logger 'ERROR level'. Se debi� visualizar 2 logs."<<endl<<endl;
}
...
void PruebasLoggerWarn()
{
	...
	cout<<"Finalizadas Pruebas Logger 'WARN level'. Se debi� visualizar 3 logs."<<endl<<endl;
}
...
void PruebasLoggerInfo()
{
	...
	cout<<"Finalizadas Pruebas Logger 'INFO level'. Se debi� visualizar 4 logs."<<endl<<endl;
}
void PruebasLoggerDebug()
{
	...
	cout<<"Finalizadas Pruebas Logger 'DEBUG level'. Se debi� visualizar 5 logs."<<endl<<endl;
}
...
void PruebasLoggerTrace()
{
	...
	cout<<"Finalizadas Pruebas Logger 'TRACE level'. Se debi� visualizar 6 logs."<<endl<<endl;
}
*/
